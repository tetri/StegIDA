...
public class Info {
	...
	public void clear() {
		...
		for (int i = 0; i < residues; i++) { // unpack does the range
			// checking
	...
	public Properties getInfoAsProperties() {
		Properties props = new Properties();
		props.put("version", String.valueOf(new Integer(version)));
		props.put("channels", String.valueOf(new Integer(channels)));
		props.put("sampling_rate", String.valueOf(new Integer(rate)) + " Hz");
		props.put("max_bitrate", String.valueOf(new Integer(
				bitrate_upper / 1000))
				+ " kbps");
		props.put("nominal_bitrate", String.valueOf(new Integer(
				bitrate_nominal / 1000))
				+ " kbps");
		props.put("min_bitrate", String.valueOf(new Integer(
				bitrate_lower / 1000))
				+ " kbps");
		return props;
	}
