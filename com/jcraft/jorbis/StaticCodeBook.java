...
class StaticCodeBook {
	...
	static final int VQ_FEXP_BIAS = 768; // bias toward values smaller than
											// 1.
	...
	/*
	 * // TEST // Unit tests of the dequantizer; this stuff will be OK //
	 * cross-platform, I simply want to be sure that special mapping cases //
	 * actually work properly; a bug could go unnoticed for a while
	 *  // cases: // // no mapping // full, explicit mapping // algorithmic
	 * mapping // // nonsequential // sequential
	 * 
	 * static int[] full_quantlist1={0,1,2,3, 4,5,6,7, 8,3,6,1}; static int[]
	 * partial_quantlist1={0,7,2};
	 *  // no mapping static StaticCodeBook test1=new StaticCodeBook(4,16,null,
	 * 0,0,0,0,0, null,null,null); static float[] test1_result=null;
	 *  // linear, full mapping, nonsequential static StaticCodeBook test2=new
	 * StaticCodeBook(4,3,null, 2,-533200896,1611661312,4,0, full_quantlist1,
	 * null, null); static float[] test2_result={-3,-2,-1,0, 1,2,3,4, 5,0,3,-2};
	 *  // linear, full mapping, sequential static StaticCodeBook test3=new
	 * StaticCodeBook(4,3,null, 2, -533200896,1611661312,4,1,
	 * full_quantlist1,null, null); static float[] test3_result={-3,-5,-6,-6,
	 * 1,3,6,10, 5,5,8,6};
	 *  // linear, algorithmic mapping, nonsequential static StaticCodeBook
	 * test4=new StaticCodeBook(3,27,null, 1,-533200896,1611661312,4,0,
	 * partial_quantlist1,null,null); static float[] test4_result={-3,-3,-3,
	 * 4,-3,-3, -1,-3,-3, -3, 4,-3, 4, 4,-3, -1, 4,-3, -3,-1,-3, 4,-1,-3,
	 * -1,-1,-3, -3,-3, 4, 4,-3, 4, -1,-3, 4, -3, 4, 4, 4, 4, 4, -1, 4, 4,
	 * -3,-1, 4, 4,-1, 4, -1,-1, 4, -3,-3,-1, 4,-3,-1, -1,-3,-1, -3, 4,-1, 4,
	 * 4,-1, -1, 4,-1, -3,-1,-1, 4,-1,-1, -1,-1,-1};
	 *  // linear, algorithmic mapping, sequential static StaticCodeBook
	 * test5=new StaticCodeBook(3,27,null, 1,-533200896,1611661312,4,1,
	 * partial_quantlist1,null,null); static float[] test5_result={-3,-6,-9, 4,
	 * 1,-2, -1,-4,-7, -3, 1,-2, 4, 8, 5, -1, 3, 0, -3,-4,-7, 4, 3, 0, -1,-2,-5,
	 * -3,-6,-2, 4, 1, 5, -1,-4, 0, -3, 1, 5, 4, 8,12, -1, 3, 7, -3,-4, 0, 4, 3,
	 * 7, -1,-2, 2, -3,-6,-7, 4, 1, 0, -1,-4,-5, -3, 1, 0, 4, 8, 7, -1, 3, 2,
	 * -3,-4,-5, 4, 3, 2, -1,-2,-3};
	 * 
	 * void run_test(float[] comp){ float[] out=unquantize(); if(comp!=null){
	 * if(out==null){ System.err.println("_book_unquantize incorrectly returned
	 * NULL"); System.exit(1); } for(int i=0;i<entries*dim;i++){
	 * if(Math.abs(out[i]-comp[i])>.0001){ System.err.println("disagreement in
	 * unquantized and reference data:\nposition "+i+": "+out[i]+" !=
	 * "+comp[i]); System.exit(1); } } } else{ if(out!=null){
	 * System.err.println("_book_unquantize returned a value array:\n correct
	 * result should have been NULL"); System.exit(1); } } }
	 * 
	 * public static void main(String[] arg){ // run the nine dequant tests, and
	 * compare to the hand-rolled results System.err.print("Dequant test 1...
	 * "); test1.run_test(test1_result); System.err.print("OK\nDequant test 2...
	 * "); test2.run_test(test2_result); System.err.print("OK\nDequant test 3...
	 * "); test3.run_test(test3_result); System.err.print("OK\nDequant test 4...
	 * "); test4.run_test(test4_result); System.err.print("OK\nDequant test 5...
	 * "); test5.run_test(test5_result); System.err.print("OK\n\n"); }
	 */
}
