...
public class StreamState {
	...
	void body_expand(int needed) {
		if (body_storage <= body_fill + needed) {
			...
			body_data = foo;
			// System.out.println("expand: body_fill="+body_fill+",
			// body_storage="+body_data.length);
		}
	}
	...
	public int pageout(Page og) {
		...
		// System.out.println("pageout: e_o_s="+e_o_s+"
		// lacing_fill="+lacing_fill+" body_fill="+body_fill+",
		// lacing_fill="+lacing_fill+" b_o_s="+b_o_s);
		...
		// /* If this is the initial header case, the first page must only
		// include
		// the initial header packet */
		// if(b_o_s==0){ /* 'initial header page' case */
		// pcm_pos=0;
